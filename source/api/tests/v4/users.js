...
test('/users | GET | 400', async (t) => {
  await fetch(`${t.context.baseUrl}/v4/users?session=abcd`, {
    method: 'get',
    headers: {
      Accept: 'application/json',
      'Content-Type': 'application/json',
...
test('/users | GET | 401', async (t) => {
  await fetch(`${t.context.baseUrl}/v4/users?session=123456789012345678901234567890123456`, {
    method: 'get',
    headers: {
      Accept: 'application/json',
      'Content-Type': 'application/json',
  ...
  await fetch(`${t.context.baseUrl}/v4/register`, {
    ...
    .then(async (data) => {
      await fetch(`${t.context.baseUrl}/v4/login`, {
        ...
        .then((res2) => res2.json())
        .then(async (data2) => {
          await fetch(`${t.context.baseUrl}/v4/users?session=${data2.session}`, {
            method: 'get',
            headers: {
              Accept: 'application/json',
              'Content-Type': 'application/json',
...
test('/users | DELETE | 400', async (t) => {
  await fetch(`${t.context.baseUrl}/v4/users`, {
    ...
    .then((res) => res.json())
    .then(async (data) => {
      await fetch(`${t.context.baseUrl}/v4/users/${data.userID}?session=abcd`, {
        method: 'delete',
        headers: {
          Accept: 'application/json',
          'Content-Type': 'application/json',
...
test('/users | DELETE | 401', async (t) => {
  await fetch(`${t.context.baseUrl}/v4/users/1?session=123456789012345678901234567890123456`, {
    method: 'delete',
    headers: {
      Accept: 'application/json',
      'Content-Type': 'application/json',
...
test('/users | DELETE | 406', async (t) => {
  await fetch(`${t.context.baseUrl}/v4/users/10000?session=${t.context.session}`, {
    method: 'delete',
    headers: {
      Accept: 'application/json',
      'Content-Type': 'application/json',
...
test('/users | DELETE | 200', async (t) => {
  await fetch(`${t.context.baseUrl}/v4/users`, {
    ...
    .then((res) => res.json())
    .then(async (data) => {
      await fetch(`${t.context.baseUrl}/v4/users/${data.userID}?session=${t.context.session}`, {
        method: 'delete',
        headers: {
          Accept: 'application/json',
          'Content-Type': 'application/json',
